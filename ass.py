...
#Initialize the three categories
...
#loop through the students record
for student in students:
	student_id.append(student["id"])
	student_name.append(student["name"])
	student_score.append(student["score"])

	student_record = {student["id"]: (student["name"], student["score"])}
	if student["score"] >= 70:
		high_performance.append(student_record)
	elif student["score"] >= 50 and student["score"] < 70:
		average_performance.append(student_record)
	else:
		low_performance.append(student_record)
# Print students record
print("\n\t\t\tSTUDENTS RECORD\n")
print(f"STUDENTS ID: {student_id}\n")
print(f"STUDENTS NAME: {student_name}\n")
print(f"STUDENTS SCORES: {student_score}")

# Print summary
print("\n\t\t\tSUMMARY REPORT\n")
print(f" HIGH PERFORMANCE: {len(high_performance)}")
print(f" AVERAGE PERFORMANCE: {len(average_performance)}")
print(f" LOW PERFORMANCE: {len(low_performance)}")

# Print each group
print("\n\t\t\tEACH GROUP\n")
print(f"\nHIGH PERFORMANCE: {high_performance}")
print(f"\nAVERAGE PERFORMANCE: {average_performance}")
print(f"\nLOW PERFORMANCE: {low_performance}")
